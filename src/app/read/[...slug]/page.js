...
export default function Read({ params }) {
    ...
    const [page_font, setPageFont] = useState('system-ui')
    ...
    async function handleTranslate() {
        ...
        setIsTranslate(true)
        const response = await translate(data?.content)
    ...
    return <section className='w-full container mx-auto flex flex-col items-center mb-[60px] mt-[60px] lg:mt-[60px] lg:mb-[20px] px-5 md:px-10 relative'>
        {
            isLoading ? <Loader /> : <>
